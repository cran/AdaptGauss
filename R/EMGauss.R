...
#' @param K estimated amount of Gaussian Kernels
...
#' @param MaxNumberofIterations Optional, Number of Iterations; default=10
#' @param fast Default: FALSE: Using mclust's EM see function densityMclust of that package, TRUE: Naive but faster EM implementation, which may be numerical unstable, because log(gauss) is not used 
#'
#' @details
#'  
