...
#' @param Color Optional, character vector of colors, default rainbow()
#' @param xlab Optional, label of x-axis, default 'Data', see intern R documentation
#' @param lwd Width of Line, see intern R documentation
#' 
#' @details
